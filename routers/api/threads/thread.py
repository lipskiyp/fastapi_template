...
from app.controllers import ThreadController, MessageController
...
from app.services.controllers import ThreadControllerService
...
async def add_or_remove_users_from_thread(
    ...
    """
    Adds or removes users to/from a Thread.
    """
